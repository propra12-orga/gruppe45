		...
		public void tick() {
			...
			if (timeRest == 0) {
				...
				// nun Items entstehen...
					...
					// ITEM: Bomb Strength (Erhöht die Durchschlagskraft von Bomben)
					} else if (random < (PROBABILITY_HEALTH + PROBABILITY_XTRA_BOMB + PROBABILITY_PORTAL + PROBABILITY_BOMB_RANGE + PROBABILITY_BOMB_STRENGTH)) {
