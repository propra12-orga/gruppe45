...
public class Window {// implements Runnable {
	...
	final static public int level_size_x = 16;	// X-Ausdehnung der Spielwelt
	final static public int level_size_y = 16;	// Y-Ausdehnung der Spielwelt
	final static public int level_size_z = 16;	// Z-Ausdehnung der Spielwelt
